...
const TRUST_POINTS = [
  {
    ...
    body: 'Inqilab Trading Corporation products meet local industrial and fire safety standards.',
  },
  {
    icon: faTruck,
  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <h3 className='mt-2 text-xl font-extrabold text-brand-ink sm:text-2xl'>
      ...
      <div className='grid gap-4 lg:grid-cols-[1.1fr_0.9fr]'>
        <div className='rounded-2xl border border-brand-border bg-brand-surface/60 p-5'>
          <div className='flex items-center gap-2'>
            <FontAwesomeIcon icon={faFilePdf} className='text-brand-primary' />
            ...
            <div className='mt-4 space-y-2'>
              {pdfEntries.map(([key, url]) => (
                <a
                  ...
                  className='group flex items-center justify-between gap-3 rounded-xl border border-brand-border bg-white px-4 py-3 transition hover:border-brand-primary'
                >
                  <span className='flex items-center gap-3'>
                    <span className='grid h-9 w-9 place-items-center rounded-lg bg-brand-primary/10 text-brand-primary'>
                  ...
                  <FontAwesomeIcon
                    icon={faDownload}
                    className='text-brand-muted transition group-hover:text-brand-primary'
                  />
                </a>
              ))}
            </div>
          ) : (
            <div className='mt-4 rounded-xl border border-dashed border-brand-border bg-white p-5 text-center'>
              ...
              <a
                ...
                className='mt-3 inline-flex items-center gap-2 text-sm font-bold text-brand-primary hover:underline'
              >
        ...
        <div className='rounded-2xl border border-brand-primary/30 bg-gradient-to-br from-brand-primary to-brand-primary-dark p-5 text-white shadow-lg'>
          ...
          <div className='mt-4 flex flex-col gap-2 sm:flex-row'>
            <a
              ...
              className='inline-flex items-center justify-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-bold text-brand-primary transition hover:bg-white/90'
            >
      ...
      <div className='grid gap-3 sm:grid-cols-3'>
        {TRUST_POINTS.map((t) => (
          ...
          >
            ...
            <p className='mt-3 text-sm font-bold text-brand-ink'>{t.title}</p>
            <p className='mt-1 text-xs leading-5 text-brand-muted'>{t.body}</p>
          </div>
        ))}
      </div>
    </div>
