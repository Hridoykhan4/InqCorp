...
const ProductAccordion = ({ item }) => {
    ...
    return (
        <div className='overflow-hidden rounded-2xl border border-brand-border bg-gradient-to-br from-brand-surface to-white'>
            <div className='flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6'>
                ...
                <button
                    onClick={handleModal}
                    className='inline-flex shrink-0 items-center justify-center gap-2 rounded-full bg-brand-primary px-6 py-3 text-sm font-bold text-white shadow-md transition hover:-translate-y-0.5 hover:bg-brand-primary-dark'
                >
                    Send Inquiry
