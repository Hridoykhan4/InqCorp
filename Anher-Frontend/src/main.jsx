    ...
    children: [
      ...
      { path: '/gallery',           element: <Suspense fallback={<PageLoader />}><Gallery /></Suspense> },
      {
        ...
        children: [
          ...
          { path: '/dashboard/live-rates',    element: <Suspense fallback={<PageLoader />}><DashboardPriceList /></Suspense> },
          { path: '/dashboard/pricelist',     element: <Navigate to="/dashboard/live-rates" replace /> },
